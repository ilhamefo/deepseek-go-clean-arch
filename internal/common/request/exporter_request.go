...
type RekapRequest struct {
	...
	DateStart string `json:"date_start" form:"date_start" validate:"required,datetime=2006/01/02,max=100" example:"2025/09/01"`
	DateEnd   string `json:"date_end" form:"date_end" validate:"required,datetime=2006/01/02,max=100" example:"2025/09/30"`
